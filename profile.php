        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-dark p-0" id="content">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="dashboard.html"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a><a class="nav-link" href="menu.html"><i class="fas fa-book-open"></i><span>Menu</span></a></li>
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="karyawan.html"><i class="fas fa-user-circle"></i><span>Karyawan</span></a><a class="nav-link" href="dashboard.html"><i class="fas fa-utensils"></i><span>Restoran</span></a></li>
                </ul>
